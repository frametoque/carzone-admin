...
import { createQuotation, getClients, createClient } from "../../actions/actions";
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <select name="clientId" value={formData.clientId} onChange={handleFormChange}
                ...
                <option value="" className="bg-black">Choose a client...</option>
            ...
            {showNewClientForm && (
              <div className="p-4 bg-black-500/10 border border-white/10 rounded-xl space-y-3">
                ...
                <textarea name="address" placeholder="Billing Address (Optional)" value={newClientData.address} onChange={handleNewClientChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 outline-none focus:border-brand-500 transition-colors text-sm resize-none"
                  rows={2} />
        ...
        <div className="space-y-8">
            ...
            <div className="border-t border-white/10 mt-6 pt-4 space-y-3">
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                <input type="number" name="discount" value={formData.discount || ""} onChange={handleFormChange} min="0"
                  className="w-24 bg-white/5 border border-white/10 rounded-lg px-3 py-1 outline-none focus:border-brand-500 transition-colors text-right text-sm"
                  placeholder="0.00" />
              </div>
              <div className="flex justify-between items-center text-sm">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 space-y-4">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <input type="number" name="advance" value={formData.advance || ""} onChange={handleFormChange} min="0"
                className="w-32 bg-white/5 border border-white/10 rounded-lg px-3 py-1.5 outline-none focus:border-brand-500 transition-colors text-right text-sm"
                placeholder="0.00" />
            </div>
          ...
          <div className="flex flex-col gap-3">
            <button className="flex items-center justify-center gap-2 px-6 py-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-3xl font-semibold transition-colors">
